...
import com.example.shrinkio.dummy.DummyContent;
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString( PersonDetailFragment.ARG_ITEM_ID, item.id );
                    ...
                    intent.putExtra( PersonDetailFragment.ARG_ITEM_ID, item.id );
